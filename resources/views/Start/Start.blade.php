    ...
    <div class="row">
      <div class="col-12 pb-5">
        <p>
          ...
          <a href="?url=produkte" class="link">Mahlzeiten</a>
      ...
      <div class="col-12">
        <p>
          ...
          <a href="?url=registrieren" class="link">hier</a>
  ...
  <div class="col-9">
    <div class="row">
      ...
      <div class="col-3 pb-5 py-2">
        <a class="btn btn-block" href="?url=registrieren" role="button">
          <i class="fa fa-hand-o-right"></i> Registrieren
        </a>
        <br />
        <a class="btn btn-block" href="?url=login" role="button">
